...
import type { UseReverseGeocodeResult } from './useReverseGeocode';

export type { UseReverseGeocodeResult } from './useReverseGeocode';

/**
 * expo-location's reverseGeocodeAsync is unavailable on web, so this variant
 * falls back to the Google Geocoding REST API via googleMapsClient.
 */
