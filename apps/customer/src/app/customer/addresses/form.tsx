...
export default observer(function AddressFormScreen() {
  ...
  const isValid = addressLine1.trim().length > 0 && state.trim().length > 0 && pincode.trim().length > 0;
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.defaultRow}>
          <Text style={[theme.textPresets.bodyMedium, { color: theme.colors.textPrimary }]}>
...
const styles = StyleSheet.create({
  ...
  defaultRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 },
